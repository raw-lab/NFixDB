...
taxid = tophits[['GenomeID', 'NCBI_TaxID', 'location_nflH', 'alnLen_nflH', 'seqLen_nflH', 'location_nflD', 'alnLen_nflD', 
                'seqLen_nflD', 'location_ChlB', 'alnLen_ChlB', 'seqLen_ChlB', 'location_ChIl', 'alnLen_ChIl', 'seqLen_ChIl', 
                'location_ChlN', 'alnLen_ChlN', 'seqLen_ChlN']]

filthits = pd.DataFrame(pd.read_table('filt_wSSU_i3.tsv'))
